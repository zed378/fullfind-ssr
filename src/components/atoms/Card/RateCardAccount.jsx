...
export default function RateCardAccount() {
  return (
            ...
            <Fade direction="down" duration={750} cascade>
              <ul className="w-full flex flex-col gap-2">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Supports account management activities under supervision,
                    ensuring effective communication and meeting client needs
            ...
            <Fade direction="down" duration={750} cascade>
              <ul className="w-full flex flex-col gap-2">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Advanced in strategic account management and negotiation
                    techniques
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Manages key accounts independently, develops long-term
                    relationships, and identifies opportunities for growth and
            ...
            <Fade direction="down" duration={750} cascade>
              <ul className="w-full flex flex-col gap-2">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Expert in leading sales teams and managing significant
                    client portfolios
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Oversees the account management team, sets strategic goals,
                    and ensures high levels of customer satisfaction and
                    loyalty. Responsible for major client acquisitions and
