...
export default function RateCardUIUX() {
  return (
            ...
            <Fade direction="down" duration={750} cascade>
              <ul className="w-full flex flex-col gap-2">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Proficient in Figma, Photoshop, HTML & CSS
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <img
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Assists in the design and development of web/app pages,
                    working under close supervision to ensure alignment with
                    design guidelines.
                  </p>
                </li>
              </ul>
            ...
            <Fade direction="down" duration={750} cascade>
              <ul className="w-full flex flex-col gap-2">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Advanced in design software and tools
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <img
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Independently manages web/app design projects, ensuring
            ...
            <Fade direction="down" duration={750} cascade>
              <ul className="w-full flex flex-col gap-2">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Expert in comprehensive design platforms
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <img
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Directs the web/app design team, strategizing on large-scale
                    projects to enhance functionality and aesthetic appeal.
                  </p>
                </li>
              </ul>
            </Fade>
