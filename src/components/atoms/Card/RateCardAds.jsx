...
export default function RateCardAds() {
  return (
          ...
          <Fade direction="down" duration={750} cascade>
            <ul className="w-full flex flex-col gap-2">
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                  Proficient in Google Ads and Meta Ads Manager
                </p>
              </li>
              <li className="flex items-start gap-3">
                <img
                ...
                <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                  Supports the creation and monitoring of ad campaigns under
                  supervision, ensuring optimal configuration and performance
                  tracking.
                </p>
              </li>
            </ul>
          ...
          <Fade direction="down" duration={750} cascade>
            <ul className="w-full flex flex-col gap-2">
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                  Advanced in various online advertising platforms
                </p>
              </li>
              <li className="flex items-start gap-3">
                <img
                ...
                <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                  Manages complex ad campaigns, analyzes performance data, and
                  provides strategic insights to maximize ad spend efficiency.
                </p>
              </li>
            </ul>
          </Fade>
          ...
          <Fade direction="down" duration={750} cascade>
            <ul className="w-full flex flex-col gap-2">
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                  Expert in multi-platform ad management
                </p>
              </li>
              <li className="flex items-start gap-3">
                <img
                ...
                <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                  Oversees the paid advertising team, guiding large-scale ad
                  strategies and innovations for enhanced campaign results.
                </p>
              </li>
            </ul>
          </Fade>
