...
export default function RateCardPM() {
  return (
            ...
            <Fade direction="down" duration={750} cascade>
              <ul className="w-full flex flex-col gap-2">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Proficient in tools like Trello, Asana & ClickUp
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <img
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Assists with managing project timelines and coordinating
                    team tasks under close guidance to ensure project alignment
                    with goals.
                  </p>
                </li>
              </ul>
            ...
            <Fade direction="down" duration={750} cascade>
              <ul className="w-full flex flex-col gap-2">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Advanced in project various management software
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <img
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Independently manages complex projects, ensuring effective
                    resource allocation and milestone achievement.
                  </p>
                </li>
              </ul>
            </Fade>
            ...
            <Fade direction="down" duration={750} cascade>
              <ul className="w-full flex flex-col gap-2">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Expert in advanced project management techniques and tools
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <img
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Leads multiple project teams, sets strategic project
                    directions, and ensures optimal outcomes through effective
