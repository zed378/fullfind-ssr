...
export default function RateCardDes() {
  return (
            ...
            <Fade direction="down" duration={750} cascade>
              <ul className="w-full flex flex-col gap-2">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    An efficient team member who supports design projects under
                    supervision, focusing on crafting eye-catching designs.
                  </p>
                </li>
              </ul>
            </Fade>
            ...
            <Fade direction="down" duration={750} cascade>
              <ul className="w-full flex flex-col gap-2">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Advanced in a variety of graphic design software, including
                    AI
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Capable of working independently or leading small design
                    projects, skilled in developing complex and creative visual
                    solutions.
                  </p>
                </li>
              </ul>
            ...
            <Fade direction="down" duration={750} cascade>
              <ul className="w-full flex flex-col gap-2">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Expert in multiple graphic design platforms
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <img
                  ...
                  <p className="w-4/5 hd:text-lg 3xl:text-base 2xl:text-lg xl:text-base lg:text-lg">
                    Leads and mentors a team of designers, oversees major design
                    projects, and ensures a cohesive visual identity across all
                    media.
                  </p>
                </li>
              </ul>
