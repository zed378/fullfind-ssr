...
import yt from "icons/intercom.svg";
import insta from "icons/sort1.svg";
import tiktok from "icons/slack.svg";
import vid from "role/va.webp";

// constant
import { padding } from "constant/padding";

export default function VABanner() {
  return (
    <div
        ...
        <div className="xl:w-1/3 lg:w-1/2 xs:w-5/6 h-full flex items-center order-1 xl:order-2 mt-10">
          <div className="relative">
            <Fade
              direction="left"
              duration={1000}
              className="absolute z-20 hd:left-16 hd:-top-2 3xl:left-14 3xl:-top-16 2xl:left-12 2xl:-top-10 xl:left-6 xl:-top-8 lg:-top-8 lg:left-8 xs:left-6 xs:-top-8 "
            >
              <img
                src={yt}
                alt="Youtube icons"
            ...
            <Fade
              direction="left"
              duration={1000}
              className="absolute z-20 hd:-right-8 hd:bottom-1/4 3xl:bottom-1/4 3xl:-right-7 2xl:bottom-1/4 2xl:-right-8 xl:bottom-1/4 xl:-right-7 lg:bottom-1/4 lg:-right-8 xs:bottom-1/4 xs:-right-7 "
            >
              <img
                src={insta}
                alt="Instagram icons"
            ...
            <Fade
              direction="left"
              duration={1000}
              className="absolute z-20 hd:left-2/3 hd:-bottom-16 3xl:left-2/3 3xl:-bottom-0 2xl:-bottom-10 2xl:left-2/3 xl:-bottom-7 xl:left-2/3 lg:-bottom-8 lg:left-2/3 xs:-bottom-7 xs:left-2/3 "
            >
              <img
                src={tiktok}
                alt="Tiktok icons"
            ...
            <Fade direction="right" duration={1000}>
              <img
                src={cube}
                alt="Video Editor"
                className="hd:h-[375px] 3xl:h-[325px] 2xl:h-[325px] xl:h-[300px] lg:h-[400px] xs:h-[285px] w-auto z-0 absolute hd:top-20 3xl:top-0 2xl:top-7 2xl:-left-10 animate-spin-very-slow"
              />
            </Fade>
        ...
        >
          ...
          <Fade direction="down" duration={1000}>
            <h1 className="hd:text-[65px] 3xl:text-[50px] 2xl:text-5xl xl:text-4xl lg:text-5xl xs:text-3xl 2xl:leading-tight font-black 3xl:leading-tight mt-6 xl:text-left xs:text-center">
              Hire Vetted{" "}
              <span className="text-blue-600">Virtual Assistants</span> and Save
              70% in Staffing Costs.
            </h1>
          </Fade>
          ...
          >
            <RoleBtn nav={false} val="Hire a Virtual Assistant" />
          </Fade>
        </div>
      </div>
    </div>
