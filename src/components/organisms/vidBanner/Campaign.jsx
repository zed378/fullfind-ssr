...
export default function VidBannerCampaign() {
  return (
    <div
      className={`w-full h-auto xl:px-16 xs:px-8 hd:pb-20 hd:pt-12 3xl:py-20 2xl:py-20 xl:py-12 xs:py-16 bg-[#F2EBEC] `}
    >
      <div className="flex flex-wrap xl:flex-row xs:flex-col items-center hd:justify-center hd:gap-40 3xl:justify-around 2xl:justify-start 2xl:gap-28 xl:gap-0 lg:gap-32 xl:justify-between relative">
        ...
        <div id="banner" className="xl:w-[55%] xs:w-full order-2 xl:order-1 ">
