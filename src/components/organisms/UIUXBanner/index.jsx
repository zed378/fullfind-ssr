...
// assets
import vid from "role/adsadmin.webp";
...
export default function UIUXBanner() {
  return (
        ...
        >
          ...
          <Fade direction="right" duration={750}>
            <p className={bannerSubtitle}>
              Get access to skilled administrators equipped with the latest AI
              tools to streamline your operations and maximize productivity.
            </p>
          </Fade>
          ...
          >
            <RoleBtn nav={false} val="AI-Powered Administrative Assistants" />
          </Fade>
        </div>
      </div>
    </div>
