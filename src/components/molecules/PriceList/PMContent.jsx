...
import { RateCardPM } from "atoms/Card";

// assets
import vid1 from "role/pm1.webp";
          ...
          <Fade direction="down" duration={1000}>
            <h1 className="xl:text-left xs:text-center hd:text-[3.2rem] try:text-[3.2rem] 3xl:text-[2.8rem] 2xl:text-5xl lg:text-[2.5rem] xs:text-3xl font-bold">
              ...
              <span className="text-blue-600">
                project manager are proficient
              </span>{" "}
              in the latest project management tools and methodologies.
            </h1>
          </Fade>

          <Fade direction="up" duration={1000}>
            <p className="xl:text-left xs:text-center hd:text-2xl 2xl:text-2xl xl:text-xl xs:text-xl">
              Whether you're coordinating digital projects or streamlining
              cross-functional team efforts, our project managers ensure your
              projects are completed on time, within budget, and to your
              specifications.
            </p>
          </Fade>
        </div>
