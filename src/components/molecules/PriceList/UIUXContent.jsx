...
import { RateCardUIUX } from "atoms/Card";
          ...
          <Fade direction="down" duration={1000}>
            <h1 className="xl:text-left xs:text-center hd:text-[3.2rem] try:text-[3.2rem] 3xl:text-[2.8rem] 2xl:text-5xl lg:text-[2.5rem] xs:text-4xl font-bold">
              ...
              <span className="text-blue-600">
                UI/UX designers are proficient
              </span>{" "}
              in the latest design technologies.
            </h1>
          </Fade>

          <Fade direction="up" duration={1000}>
            <p className="xl:text-left xs:text-center hd:text-2xl 2xl:text-2xl xl:text-xl xs:text-xl">
              Whether you're launching a new website or optimizing existing
              interfaces for better user experiences, our expert UI/UX designers
              are here to ensure your online presence stands out.
            </p>
          </Fade>
        </div>
      </div>
